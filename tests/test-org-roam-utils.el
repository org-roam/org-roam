...
(describe "org-roam--memoize"
  :var ((dur-unmemoized
        ...
        ;; New KEY every time.
        ;; This is why the source checks (memq org-roam--memo-timer timer-list),
        ;; or it would be much, much worse.
  ...
  (it "shortens 1000 calls to have the runtime of at most 100 calls"
    ;; It's likely a fair bit better, but be permissive in this test case.
