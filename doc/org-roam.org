...
work with the ~sqlite3~ database. Both of them should be installed automatically
in your Emacs environment as prerequisite for Org-roam when you install
it.
...
your Emacs configuration folder like this: ~/.config/emacs/elpa/emacsql-sqlite-20190727.1710/sqlite~
* Getting Started
** The Org-roam Node
