...
- ~org-roam-display-node-dedicated-buffer~: Launch an Org-roam buffer for a
  specific node without visiting its file. Unlike ~org-roam-buffer-toggle~ you
...
org-roam-display-node-dedicated-buffer~.

- Function: org-roam-display-node-dedicated-buffer
