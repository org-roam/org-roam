...
To use Anki for spaced repitition you might want to use [[https://github.com/louietan/anki-editor][louietan/anki-editor]] which syncs your cards to Anki via [[https://github.com/FooSoft/anki-connect#installation][anki-connect]].
